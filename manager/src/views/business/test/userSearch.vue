			...
			<Card>
                ...
                /> -->
						...
						<i-col v-show="display"
							...
							<FormItem prop="hobby"
								...
								<Select v-model="searchModel.hobby">
									<Option v-for="item in hobbyList"
													:value="item.value"
						...
						<i-col v-show="display"
							...
							<FormItem prop="address"
												label="档案状态">
								<basicinfo-select v-model="searchModel.address"
																	:url="selectUrl"
																	:parentValue="parentValue"
																	:hasDefaultSelect="true"></basicinfo-select>
							</FormItem>
						</i-col>
