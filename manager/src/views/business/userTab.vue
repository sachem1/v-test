<template>
  <Tabs type="card">
    <TabPane label="表头">
      ...
      >
        <Row :gutter="16">
          <Col span="12">
            <i-col>
              <FormItem prop="LoginName" label="登录账号长度">
                <Input
                  type="text"
        ...
        <Row :gutter="16">
          <Col span="8">
            <FormItem prop="LoginName" label="LoginName" label-position="top">
        ...
        <Row :gutter="16">
          ...
          <Col span="6">
            <FormItem label="Remark" label-position="top">
    ...
    <TabPane label="表体">
      <Row>
        <Card>
          <Button type="primary" @click="clickTest">打印</Button>
          <Button type="primary" @click="clickTest">导入</Button>
          <Button type="primary" @click="clickTest">下载</Button>
        </Card>
      </Row>
      <Row>
        <Card>
