				...
				<Form ref="formMainData" :model="formMainData">
					<Row :gutter="32">
						...
						<FormItem label="LoginName"
											label-position="top">
							<Input v-model="formMainData.LoginName">
							</Input>
						</FormItem>
						</Col>
					</Row>
					<Row :gutter="32">
						...
						<FormItem label="Password"
											label-position="top">
							<Input v-model="formMainData.Password">
							</Input>
						</FormItem>
						</Col>
					</Row>
        ...
        <TabPane label="表体">
			<Form ref="formDetailData"  :model="formDetailData">
					<Row :gutter="32">
						...
						<FormItem label="Age"
											label-position="top">
							<Input v-model="formDetailData.Age">
							</Input>
						</FormItem>
						</Col>
					</Row>
                    ...
                    <Row><Button type="primary" @click="handleDetailSubmit">保存</Button></Row>
				</Form>
		</TabPane>
    ...
    export default {
        ...
        data(){
            return {
                ...
                mainServiceName:'users/createUser',
                detailServiceName:'users/createUser'
            }
        },
        methods:{
            handleMainSubmit(){
