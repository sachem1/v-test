<template>
  <div class="list-wrapper">
    <div class="list-search">
      <img-Search @searchList="handleSearch"></img-Search>
    </div>
...
import imgSearch from "_vbue/bsbookrecord/eRecordInfo/orgImgHistorySearch.vue";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: "料件货号", width: 150, key: "imgno", align: "center" },
        { title: "料件序号", width: 100, key: "gno", align: "center" },
        { title: "商品编码", width: 100, key: "hscode", align: "center" },
        { title: "商品名称", width: 150, key: "gname", align: "center" },
        ...
        { title: "法定第二单位", width: 130, key: "unit2cn", align: "center" },
         { title: "单价", width: 80, key: "decprice", align: "center" },
         { title: "申报数量", width: 100, key: "qty", align: "center" },
         { title: "币制", width: 80, key: "currcn", align: "center" },
      ...
      disablePaged: false,
      serviceName: "orgImgHistoryPage",
      listUrl: "emsRecordInfo/queryImgRecordData",
      displayAccordion: "1",
      addBehaviorSetting: {
        routeName: "",
        routeParams: [
