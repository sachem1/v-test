  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: "更新时间", width: 150, key: "updateTime", align: "center" }
      ],
      ...
      buttonHandleSetting: {
        ...
        importUrl: "goodsErp/importFile",
        exportUrl: "goodsErp/downloadFile",
        templateUrl: "goodsErp/getFileTemplate"
      },
      templateSetting: {
        importType: "ERP物料关联",
        uploadFileServer: "goodserp",
        uploadFileAction: "goodsErp/ImportExcel",
        templateType: "multiple", //multiple 表示多个模板 single 表示单个模板,如果单个模板需要给模板名称
        templateName: "ERP物料关联.xls", //下载单个模板的名字,
        secondRequestUrl: "goodsErp/secondRequest",
        expendField:true
      },
      selectRows: [],
      showModalForm: false,
