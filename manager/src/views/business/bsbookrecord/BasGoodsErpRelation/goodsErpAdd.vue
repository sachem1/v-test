                ...
                <div class="form-content">
                  ...
                  >
                    <Row>
                      ...
                      <FormItem prop="goodsflag" label="物料标志" label-position="top" :label-width="150" >

                        <Select v-model="formMainData.goodsflag" filterable> 
                      ...
                      <Col :sm="24" :md="12" :lg="8">
                        <FormItem label="企业料号" label-position="top" prop="erpSku">
                     ...
                     <Row>
                      <Col :sm="24" :md="12" :lg="8">
                        <FormItem label="备案料号" label-position="top" prop="imgNo">
                          <Input v-model="formMainData.imgNo" placeholder />
                        </FormItem>
                      </Col>
                      <Col :sm="24" :md="12" :lg="8">
                     ...
                     <Row>
                      <Col :sm="24" :md="12" :lg="8">
                        <FormItem label="自定义1" label-position="top" prop="usd01">
                          <Input v-model="formMainData.usd01" placeholder />
                        </FormItem>
                      </Col>
                      <Col :sm="24" :md="12" :lg="8">
                    ...
                    <Row>
                      <Col :sm="20" :md="12" :lg="8">
                        <FormItem label="备注" label-position="top" prop="remarks">
                          <Input v-model="formMainData.remarks" placeholder />
                        </FormItem>
                      </Col>
                    </Row>
