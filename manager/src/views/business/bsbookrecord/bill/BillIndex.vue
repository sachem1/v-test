<template>
							...
							<Form ref="searchModel"
								...
								<Row>
									...
									<i-col :xs="2"
												 ...
												 :md="6"
												 :lg="8">
										<FormItem prop="BillNo"
															label="清单编号">
											<Input type="text"
														 v-model="searchModel.BillNo"
														 placeholder="清单编号"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
												 :md="6"
												 :lg="8">
										<FormItem prop="EntrySeqNo"
															label="报关单统一编号">
											<Input type="text"
														 v-model="searchModel.EntrySeqNo"
														 placeholder="报关单统一编号"></Input>
										</FormItem>
									</i-col>
								</Row>
								<Row>
									<i-col :xs="2"
												 ...
												 :md="6"
												 :lg="8">
										<FormItem prop="CopErpCode"
															label="业务跟踪号">
											<Input type="text"
														 v-model="searchModel.CopErpCode"
														 placeholder="业务跟踪号"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
												 :md="6"
												 :lg="8">
										<FormItem prop="RelativeCustomsNo"
															label="对应报关单编号">
											<Input type="text"
														 v-model="searchModel.RelativeCustomsNo"
														 placeholder="对应报关单编号"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
												 :md="6"
												 :lg="8">
										<FormItem prop="TradeMode"
															label="监管方式">
											<Input type="text"
														 v-model="searchModel.TradeMode"
														 placeholder="监管方式"></Input>
										</FormItem>
									</i-col>
								</Row>
								<Row>
									<i-col :xs="2"
												 ...
												 :md="6"
												 :lg="8">
										<FormItem prop="TransMode"
															label="运输方式">
											<Input type="text"
														 v-model="searchModel.TransMode"
														 placeholder="运输方式"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
												 :md="6"
												 :lg="8">
										<FormItem prop="GoodsFlag"
															label="成品、料件标志">
											<Input type="text"
														 v-model="searchModel.GoodsFlag"
														 placeholder="成品、料件标志"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
								...
								<Row>
									<i-col :xs="2"
												 ...
												 :md="6"
												 :lg="8">
										<FormItem prop="PreEmsId"
															label="预录入统一编号">
											<Input type="text"
														 v-model="searchModel.PreEmsId"
														 placeholder="预录入统一编号"></Input>
										</FormItem>
									</i-col>
									<i-col :xs="2"
												 :sm="4"
 ...
 -->
											<DatePicker type="date"
																	v-model="searchModel.QueryBeginDate"
																	placeholder="开始日期"
																	style="width: 115px!important"></DatePicker>
											<DatePicker type="date"
																	v-model="searchModel.QueryEndDate"
																	placeholder="结束日期"
																	style="width: 115px!important"></DatePicker>
										</FormItem>
									</i-col>
								...
								<Row class="search">
									<i-col>
										...
										<Button icon="android-search"
														type="primary"
														@click="resetFields()">重置</Button>
										<Button icon="android-search"
														type="primary"
														@click="handleSearch()">导出</Button>
										<Button icon="android-search"
														type="primary"
														@click="handleSearch()">打印</Button>
									</i-col>
								</Row>
							</Form>
						</Card>
		...
		<user-create :editForm="formData"
								 ...
								 @on-model-change="onMainFormSaved"></user-create>
	</div>
</template>
<script>
	import Vue from 'vue';
